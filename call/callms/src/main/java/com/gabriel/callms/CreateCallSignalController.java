...
public class CreateCallSignalController extends GenericCallSignalController {
	...
	public void onSubmit(ActionEvent actionEvent) {
		try {
			CallSignal callSignal = toObject(false);
			CallSignal newCallSignal = CallSignalService.getService().create(callSignal);
			manageCallSignalController.refresh();
