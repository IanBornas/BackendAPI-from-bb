...
public class SplashViewController implements Initializable {
	...
	public void onClicked(ActionEvent actionEvent)  throws IOException {
		...
		window.hide();
		if(manageScene == null){
			FXMLLoader fxmlLoader = new FXMLLoader(ManageCallSignalJFXApp.class.getResource("manage-call-view.fxml"));
			Parent root = (Parent)fxmlLoader.load();
			ManageCallSignalController controller = fxmlLoader.getController();
